    ...
    <div class="row g-4 mb-5">
      ...
      <div class="col-lg-4">
        <div class="mb-3 d-flex align-items-center gap-3">
          ...
          <img src="{{ asset('img/logo-halal.jpeg') }}" alt="Halal Indonesia" class="footer-logo mb-0"
      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <h5>Kontak Utama</h5>
        <ul class="list-unstyled small mb-0">
          <li class="mb-2"><i class="bi bi-geo-alt-fill text-danger me-2"></i> Jl. Dharmawangsa No.64, Jubung, Tawang
            Alun, Jember</li>
          <li class="mb-2"><i class="bi bi-telephone-fill text-danger me-2"></i> 0852-5722-0335</li>
          <li class="mb-2 text-break"><i class="bi bi-envelope-fill text-danger me-2"></i> 99bakeryjember@gmail.com
          </li>
          <li class="mb-2"><i class="bi bi-clock-fill text-danger me-2"></i> Setiap Hari (07.00 - 21.00 WIB)</li>
        </ul>
      </div>

      <div class="col-lg-3">
        <h5>Media Sosial</h5>
        <p class="small text-white-50 mb-3">Ikuti kabar promo terbaru & varian roti hangat setiap hari di media sosial
          kami:</p>
