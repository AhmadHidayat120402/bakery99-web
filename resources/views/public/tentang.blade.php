...
@section('meta_description',
    'Mengenal profil 99 Bakery Jember, sejarah usaha, komitmen kualitas roti hajatan &
    snackbox, serta nilai keunggulan SONGO.')
        ...
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="section-subtitle">
                    Filosofi nama "SONGO" (Bahasa Jawa: Sembilan) yang melandasi komitmen kerja dan kualitas produk di 99
                    Bakery.
                </p>
            </div>
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="songo-card">
                        ...
                        <p class="songo-desc">
                            Menghadirkan cita rasa, tekstur kelembutan roti, dan penampilan produk yang sempurna di setiap
                            gigitan
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="songo-card">
                        ...
                        <p class="songo-desc">
                            Resep kelezatan otentik khas 99 Bakery yang dibuat dari racikan resep rahasia berkualitas tanpa
                            tiruan.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="songo-card">
                        ...
                        <p class="songo-desc">
                            Memberikan kenyamanan belanja melalui gerai yang bersih, respon pemesanan WA yang ramah, serta
                            kemasan
                            aman.
                        </p>
                    </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="songo-card">
                        ...
                        <p class="songo-desc">
                            Menggunakan bahan bernutrisi, terigu pilihan, telur fresh, mentega bermutu, dan tanpa bahan
                            pengawet
                            berbahaya.
                        </p>
                    </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="songo-card">
                        ...
                        <p class="songo-desc">
                            Pelayanan optimal dan kapasitas produksi siap melayani pemesanan skala kecil maupun ratusan
                            snackbox acara
                            hajatan.
                        </p>
                    </div>
    ...
    <section class="py-5 bg-white border-bottom">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="section-subtitle">
                    Panduan dan cita-cita utama 99 Bakery Jember dalam melayani masyarakat dan berkembang secara
                    berkelanjutan.
                </p>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div
                        class="bg-white p-4 p-lg-5 rounded-4 border border-danger border-opacity-25 shadow-sm h-100 position-relative overflow-hidden">
                        <div class="feature-icon-wrapper mb-3">
                            <i class="bi bi-compass-fill fs-3"></i>
                        </div>
                        <h3 class="fw-extrabold mb-3 text-dark">Visi Perusahaan</h3>
                        <p class="text-muted mb-0" style="line-height:1.8;">
                            Menjadi toko roti spesialis pilihan utama di Jember dan sekitarnya yang dikenal atas kelezatan
                            khas,
                            kualitas higienis terjamin, serta menjadi bagian dari setiap momen kebahagiaan dan acara hajatan
                            keluarga
                            Indonesia.
                        </p>
                    </div>
                ...
                <div class="col-md-6">
                    <div
                        ...
                        <ul class="text-muted mb-0 ps-3" style="line-height:1.8;">
                            <li class="mb-2">Menyajikan produk roti & kue bermutu tinggi dengan harga yang terjangkau
                                bagi
                                seluruh lapisan masyarakat.</li>
                            <li class="mb-2">Menjaga konsistensi kesegaran produk (<em>fresh daily</em>) tanpa bahan
                                pengawet berbahaya.</li>
                            <li class="mb-2">Memberikan pelayanan terbaik, cepat, dan ramah baik untuk pembelian langsung
                                maupun pemesanan hajatan.</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container text-center">
            <div class="hajatan-banner max-w-900 mx-auto">
                ...
                <p class="text-white-50 mb-4 fs-5">
                    Jelajahi katalog lengkap roti hajatan, brownies, bolen, kue basah, dessert box, hingga kue tart ulang
                    tahun.
                </p>
